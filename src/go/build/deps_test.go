...
var pkgDeps = map[string][]string{
	...
	"internal/cfg":     {"L0"},
	"internal/poll":    {"L0", "internal/oserror", "internal/race", "syscall", "time", "unicode/utf16", "unicode/utf8", "internal/syscall/windows", "internal/syscall/unix", "internal/winver"},
	"internal/testlog": {"L0"},
